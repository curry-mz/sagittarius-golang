...
import (
	...
	"code.cd.local/sagittarius/sagittarius-golang/cores/client/rpc"
	...
	kfkCore "code.cd.local/sagittarius/sagittarius-golang/mq/kafka/core"
	"code.cd.local/sagittarius/sagittarius-golang/mq/rocket/consumer"
	"code.cd.local/sagittarius/sagittarius-golang/mq/rocket/producer"
