...
func newTextBinder() *TextBinder {
	return &TextBinder{}
}

func (jb *TextBinder) Unmarshal(body []byte, v interface{}) error {
	return json.Unmarshal(body, v)
}

func (jb *TextBinder) Marshal(v interface{}) ([]byte, error) {
	return json.Marshal(v)
}
